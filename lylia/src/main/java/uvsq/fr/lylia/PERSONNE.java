...
public final class PERSONNE implements ComportementPersonne, java.io.Serializable {
	/**
	...
	public static class PERSONNEBuilder {
		 ...
		 * </p>
		 * * @param nom Le nom de la PERSONNEBuilder.
		 * 
		 * @param prenom Le prenom de la PERSONNEBuilder.
		 */
		...
		/**
		 * méthode fonction. * @param fonction La fonction de la PERSONNEBuilder.
		 * 
		 * @return PERSONNEBuilder.
		 */
		/*
		 * CREATE TABLE Personne ( nom VARCHAR(100) not null, prenom VARCHAR(100) NOT
		 * NULL, fonction VARCHAR(100) NOT NULL, datenaisssance Date NOT NULL, PRIMARY
		 * KEY(nom,prenom) )
		 */
		...
		/**
		 * méthode dateNaissance. * @param dateNaissance La date Naissance de la
		 * PERSONNEBuilder.
		 * 
		 * @return PERSONNEBuilder.
		 */
		...
		/**
		 * méthode addNumeroTelephone. * @param numeroTelephone Le numero Telephone de
		 * la PERSONNEBuilder.
		 * 
		 * @return PERSONNEBuilder.
		 */
	...
	/**
	 * Constructeur PERSONNE. cette méthode renvoie un nouvel objet de la classe
	 * personne,il copie les valeurs des champs du générateur vers lui-même..
	 * 
	 * @param builder c'est l'objet pour le quel on veux crée un nouveau objet.
	 */
	...
	public void print() {
		...
		System.out.println("  Je suis " + this.nom + " " + this.prenom + "  née le  " + this.dateNaissance

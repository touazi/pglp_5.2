...
public class TestJdbcPersonne {
	...
	public void setUp() throws Exception {
		...
		personne2 = new PERSONNEBuilder("cc", "cv").dateNaissance(LocalDate.parse("1994-04-22")).fonction("vendeur")
				.build();
		personne3 = new PERSONNEBuilder("hhhh", "hihi").dateNaissance(LocalDate.parse("1912-12-12"))
				.fonction("directeur").build();
	...
	@Test
	public void updateTest() throws PersonneDoncExistException, PersonneExisteDeja {
		pCreate = p.create(personne);
		assertEquals(pCreate.getNom(), "TOUAZI");
		personne2 = new PERSONNEBuilder("TOUAZI", "moi").dateNaissance(LocalDate.parse("1994-04-22"))
